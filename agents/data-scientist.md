...
role: engineer
model: smart
description: Data science specialist for exploratory data analysis, statistical modeling,
  ML pipelines, data visualization, and feature engineering with Python data stack
