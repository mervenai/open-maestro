...
role: ops
model: smart
description: DigitalOcean operations agent specializing in secure account setup, infrastructure
  provisioning, and day-2 operations across compute, storage, databases, networking,
  and team management
tools:
- Read
- Edit
